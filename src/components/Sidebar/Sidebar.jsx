...
import { faHome, faHeart, faHistory, faChartLine } from '@fortawesome/free-solid-svg-icons';
import './Sidebar.scss';
  ...
  return (
    <div className="sidebar">
      ...
      <Nav className="flex-column">
        ...
        >
          <FontAwesomeIcon icon={faHome} /> For You
        </Nav.Link>
        <Nav.Link 
          as={Link} 
          to="/top-tracks" 
          className={location.pathname === '/top-tracks' ? 'active' : ''}
        >
          <FontAwesomeIcon icon={faChartLine} /> Top Tracks
        </Nav.Link>
        <Nav.Link 
          as={Link} 
          to="/favourites" 
        ...
        <Nav.Link 
          as={Link} 
          to="/recently-played" 
          className={location.pathname === '/recently-played' ? 'active' : ''}
        >
      ...
      <div className="profile-container">
        <img 
          src="/assets/images/album-covers/profile.jpg" 
          alt="User Profile" 
